...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        try:
            if dataframe.empty:
               raise SensorException("Fetched DataFrame is empty. Cannot split.", sys)
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact = DataIngestionArtifact(trained_file_path=self.data_ingestion_config.ingested_train_file_path,
